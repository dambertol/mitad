<!--
        /*
         * Vista ABM de Categoría Manuales.
         * Autor: Leandro
         * Creado: 02/06/2020
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="text-center">
                    ...
                    <?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $manuales_categoria->id) : ''; ?>
                    <a href="manuales_categorias/listar" class="btn btn-default btn-sm">Cancelar</a>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
