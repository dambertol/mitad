 ...
 */
$config['site_title']                 = "Municipalidad de Luján de Cuyo";       // Site Title, example.com
$config['admin_email']                = "autogestion@lujandecuyo.gob.ar"; // Admin Email, admin@example.com
