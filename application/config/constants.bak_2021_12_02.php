...
switch ($host) {
        case 'tad.lujandecuyo.gob.ar':
            defined('SIS_BASE_URL') OR define('SIS_BASE_URL', 'https://tad.lujandecuyo.gob.ar/');
            defined('SIS_AUTO_VER_PATH') OR define('SIS_AUTO_VER_PATH', '/');
            defined('SIS_SUB_DOMAIN') OR define('SIS_SUB_DOMAIN', 'tramites');
            break;
        default:
            defined('SIS_BASE_URL') OR define('SIS_BASE_URL', 'https://sistemamlc.lujandecuyo.gob.ar/test2/');
            defined('SIS_AUTO_VER_PATH') OR define('SIS_AUTO_VER_PATH', '/test2/');
            defined('SIS_SUB_DOMAIN') OR define('SIS_SUB_DOMAIN', '');
            break;
}



defined('SIS_EMAIL_MODULO') OR define('SIS_EMAIL_MODULO', TRUE);
defined('SIS_BASE_URL') OR define('SIS_BASE_URL', 'https://sistemamlc.lujandecuyo.gob.ar/test2');
defined('SIS_AUTO_VER_PATH') OR define('SIS_AUTO_VER_PATH', '/test2/');
defined('SIS_SUB_DOMAIN') OR define('SIS_SUB_DOMAIN', 'tramites_online');
defined('SIS_AUD_DB') OR define('SIS_AUD_DB', 'wi_test_aud');
