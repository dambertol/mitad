    ...
    function dt_column_incidencias_editar($estado, $id, $url = 'editar')
    {
        switch ($estado)
        {
            ...
            case 'Solucionada':
                ...
                break;
            default:
                return '<a href="incidencias/incidencias/' . $url . '/' . $id . '" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
                break;
        }
    }
}
    ...
    function dt_column_incidencias_anular($estado, $id)
    {
        switch ($estado)
        {
            ...
            case 'Solucionada':
                ...
                break;
            default:
                return '<a href="incidencias/incidencias/anular/' . $id . '" title="Anular" class="btn btn-primary btn-xs"><i class="fa fa-ban"></i></a>';
                break;
        }
    }
}

if (!function_exists('dt_column_incidencias_area_editar'))
{

    function dt_column_incidencias_area_editar($estado, $id)
    {
        switch ($estado)
        {
            case 'Anulada':
            ...
            case 'En Proceso':
                ...
                break;
            default:
                return '<a href="incidencias/incidencias/editar_area/' . $id . '" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
                break;
        }
    }
}

if (!function_exists('dt_column_incidencias_area_anular'))
{

    function dt_column_incidencias_area_anular($estado, $id)
    {
        switch ($estado)
        {
            case 'Anulada':
            ...
            case 'En Proceso':
                ...
                break;
            default:
                return '<a href="incidencias/incidencias/anular_area/' . $id . '" title="Anular" class="btn btn-primary btn-xs"><i class="fa fa-ban"></i></a>';
                break;
        }
    }
}
