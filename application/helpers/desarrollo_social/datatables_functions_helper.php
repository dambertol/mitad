	...
	function dt_column_compras_anular($estado, $id)
	{
		switch ($estado)
		{
			case 'Anulada':
				...
				break;
			default:
				return '<a href="desarrollo_social/compras/anular/' . $id . '" title="Anular" class="btn btn-primary btn-xs"><i class="fa fa-ban"></i></a>';
				break;
		}
	}
}
	...
	function dt_column_compras_editar($estado, $id)
	{
		switch ($estado)
		{
			case 'Anulada':
				...
				break;
			default:
				return '<a href="desarrollo_social/compras/editar/' . $id . '" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
				break;
		}
	}
}
	...
	function dt_column_entregas_anular($estado, $id)
	{
		switch ($estado)
		{
			case 'Anulada':
				...
				break;
			default:
				return '<a href="desarrollo_social/entregas/anular/' . $id . '" title="Anular" class="btn btn-primary btn-xs"><i class="fa fa-ban"></i></a>';
				break;
		}
	}
}
	...
	function dt_column_entregas_editar($estado, $id)
	{
		switch ($estado)
		{
			case 'Anulada':
				...
				break;
			default:
				return '<a href="desarrollo_social/entregas/editar/' . $id . '" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
				break;
		}
	}
}
