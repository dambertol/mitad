...
if (!function_exists('dt_column_comercios_aprobar'))
{
    ...
    function dt_column_comercios_aprobar($estado, $id)
    {
        ...
        {
            case 'Pendiente':
                return '<a href="mas_beneficios/comercios/aprobar/' . $id . '" title="Aprobar" class="btn btn-success btn-xs"><i class="fa fa-check"></i></a>';
                break;
            case 'Aprobado':
                return '';
                break;
...
if (!function_exists('dt_column_promociones_aprobar'))
{
    ...
    function dt_column_promociones_aprobar($estado, $id)
    {
        ...
        {
            case 'Pendiente':
                return '<a href="mas_beneficios/promociones/aprobar/' . $id . '" title="Aprobar" class="btn btn-success btn-xs"><i class="fa fa-check"></i></a>';
                break;
            case 'Aprobado':
                return '';
                break;
