...
<div class="row">
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2><?php echo (!empty($title_view)) ? $title_view : 'Escritorio'; ?><small>Versión 1.0.5</small></h2>
...
<?php if (!empty($graficos_data)) : ?>
	<div class="row">
		<div class="col-xs-8">
			<div class="x_panel">
				<div class="x_title">
					<h2>Pedidos por mes (último año)</h2>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
					<div class="row">
						<div class="chart-responsive">
							<div id="chart_pedidos" style="height:300px;"></div>
						</div>
		...
		$(document).ready(function() {
			...
			chart_iniciados = c3.generate({
				...
				data: {
					...
					columns: <?php echo $graficos_data['grafico_pedidos']; ?>
				},
				axis: {
					x: {
						tick: {
