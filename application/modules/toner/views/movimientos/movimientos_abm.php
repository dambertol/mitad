		...
		<div class="x_panel">
			...
			<div class="x_content">
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<table class="table table-bordered table-condensed table-striped">
										<thead>
											<tr>
												...
												<?php else: ?>
													<th style="width:70%;">Consumible</th>
												<?php endif; ?>
												<th>Llenos</th>
												<th>Vacíos</th>		
									...
									<?php if ($txt_btn === 'Agregar'): ?>
										<a href="javascript:void(0);" onclick="insertar_detalle(false)" title="Agregar Detalle" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Detalle</a>
									<?php endif; ?>
								</div>
							</div>
						</section>
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Anular') ? form_hidden('id', $movimiento->id) : ''; ?>
					<a href="toner/movimientos/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
