<!--
	/*
	 * Vista ABM de Consumible Impresora.
	 * Autor: Leandro
	 * Creado: 07/05/2019
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $consumibles_impresora->id) : ''; ?>
					<a href="toner/consumibles_impresoras/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
