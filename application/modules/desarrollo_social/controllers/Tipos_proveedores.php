...
class Tipos_proveedores extends MY_Controller
{
	...
	public function listar()
	{
		...
		$tableData = array(
				'columns' => array(
						array('label' => 'Descripcion', 'data' => 'descripcion', 'width' => 91),
						array('label' => '', 'data' => 'ver', 'width' => 3, 'class' => 'dt-body-center', 'responsive_class' => 'all', 'sortable' => 'false', 'searchable' => 'false'),
						array('label' => '', 'data' => 'editar', 'width' => 3, 'class' => 'dt-body-center', 'responsive_class' => 'all', 'sortable' => 'false', 'searchable' => 'false'),
						array('label' => '', 'data' => 'eliminar', 'width' => 3, 'class' => 'dt-body-center', 'responsive_class' => 'all', 'sortable' => 'false', 'searchable' => 'false')
				),
				'table_id' => 'tipos_proveedores_table',
				'source_url' => 'desarrollo_social/tipos_proveedores/listar_data',
				'reuse_var' => TRUE,
		...
		$this->load_template('desarrollo_social/tipos_proveedores/tipos_proveedores_listar', $data);
	}
	...
	public function listar_data()
	{
		...
		$this->datatables
				...
				->from('ds_tipos_proveedores')
				->add_column('ver', '<a href="desarrollo_social/tipos_proveedores/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
				->add_column('editar', '<a href="desarrollo_social/tipos_proveedores/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
				->add_column('eliminar', '<a href="desarrollo_social/tipos_proveedores/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
	...
	public function agregar()
	{
		...
		if (in_groups($this->grupos_solo_consulta, $this->grupos))
		{
			...
			redirect('desarrollo_social/tipos_proveedores/listar', 'refresh');
		}
		...
		$this->load_template('desarrollo_social/tipos_proveedores/tipos_proveedores_abm', $data);
	}
	...
	public function editar($id = NULL)
	{
		...
		{
			$this->session->set_flashdata('error', 'Usuario sin permisos de edición');
			redirect("desarrollo_social/tipos_proveedores/ver/$id", 'refresh');
		}
