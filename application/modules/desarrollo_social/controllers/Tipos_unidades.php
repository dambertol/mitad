...
class Tipos_unidades extends MY_Controller
{
	...
	public function listar()
	{
		...
		$tableData = array(
				...
				'source_url' => 'desarrollo_social/tipos_unidades/listar_data',
				'reuse_var' => TRUE,
		...
		$this->load_template('desarrollo_social/tipos_unidades/tipos_unidades_listar', $data);
	}
	...
	public function listar_data()
	{
		...
		$this->datatables
				...
				->from('ds_tipos_unidades')
				->add_column('ver', '<a href="desarrollo_social/tipos_unidades/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
				->add_column('editar', '<a href="desarrollo_social/tipos_unidades/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
				->add_column('eliminar', '<a href="desarrollo_social/tipos_unidades/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
	...
	public function agregar()
	{
		...
		if (in_groups($this->grupos_solo_consulta, $this->grupos))
		{
			...
			redirect('desarrollo_social/tipos_unidades/listar', 'refresh');
		}
		...
		$this->load_template('desarrollo_social/tipos_unidades/tipos_unidades_abm', $data);
	}
	...
	public function editar($id = NULL)
	{
		...
		{
			$this->session->set_flashdata('error', 'Usuario sin permisos de edición');
			redirect("desarrollo_social/tipos_unidades/ver/$id", 'refresh');
		}
