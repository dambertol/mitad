...
class Tipos_unidades_model extends MY_Model
{

	/**
	 * Modelo de Tipos de Unidades
	 * Autor: Leandro
	 * Creado: 01/10/2019
	...
	{
		parent::__construct();
		$this->table_name = 'ds_tipos_unidades';
		$this->full_log = TRUE;
		$this->msg_name = 'Tipo de Unidad';
		$this->id_name = 'id';
	...
	{
		if ($this->db->where('tipo_unidad_id', $delete_id)->count_all_results('ds_articulos') > 0)
		{
