...
class Tipos_articulos_model extends MY_Model
{

	/**
	 * Modelo de Tipos de Artículos
	 * Autor: Leandro
	 * Creado: 01/10/2019
	...
	{
		parent::__construct();
		$this->table_name = 'ds_tipos_articulos';
		$this->full_log = TRUE;
		$this->msg_name = 'Tipo de Artículo';
		$this->id_name = 'id';
	...
	{
		if ($this->db->where('tipo_articulo_id', $delete_id)->count_all_results('ds_articulos') > 0)
		{
