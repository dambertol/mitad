<!--
	/*
	 * Vista ABM de Entrega.
	 * Autor: Leandro
	 * Creado: 01/10/2019
	 * Modificado: 03/10/2019 (Leandro)
	 */
-->
<?php if (!empty($error)) : ?>
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Anular') ? form_hidden('id', $entrega->id) : ''; ?>
					<a href="desarrollo_social/entregas/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
