...
<script>
	...
	function complete_reclamos_table() {
		...
		$('#reclamos_table tfoot th').eq(7).html('<button class="btn btn-xs btn-primary" onclick="limpiar_filtro(\'reclamos_table\');"><i class="fa fa-eraser"></i></button>');
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				...
				<?php echo anchor('reclamos_gis/reclamos/agregar', 'Crear Reclamo', 'class="btn btn-primary btn-sm"') ?>
				<?php echo anchor('reclamos_gis/reclamos/exportar', 'Exportar Datos', 'class="btn btn-primary btn-sm"') ?>
