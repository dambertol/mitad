<!--
        /*
         * Vista ABM de Tipo de Iniciador.
         * Autor: Leandro
         * Creado: 22/04/2021
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="text-center">
                    ...
                    <?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $iniciadores_tipo->id) : ''; ?>
                    <a href="tramites_online/iniciadores_tipos/listar" class="btn btn-default btn-sm">Cancelar</a>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
