            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align:center; font-size:20px;">
                        <span style="line-height:100px;">Consulta&nbsp;OnLine&nbsp;Activa</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <p style='text-align:justify;'>Tenemos novedades sobre la Consulta OnLine <b>N°<?php echo $tramite; ?></b>. <b>El mismo necesita su atención</b>.</p>
                        <?php if (!empty($observaciones)) : ?>
                            <p style='text-align:justify;'><b>Observaciones:</b> <?php echo $observaciones; ?></p>
                        <?php endif; ?>
                        <?php if ($persona) : ?>
                            <p style='text-align:justify;'>
                                Puede realizar el seguimiento de su consulta a través de la siguiente URL: <a href="https://consultas.lujandecuyo.gob.ar/tramites_online/tramites/revisar/<?php echo $tramite; ?>" target="_blank">https://consultas.lujandecuyo.gob.ar/tramites_online/tramites/revisar/<?php echo $tramite; ?></a>
                            </p>
                        <?php endif; ?>
                        <p style='text-align:justify;'>
