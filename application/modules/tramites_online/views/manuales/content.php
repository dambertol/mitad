        ...
        <div class="x_panel">
            ...
            <div class="x_content" style="height:90vh;">
                ...
                <?php if (!empty($publico)) : ?>
                    <object data="<?php echo $publico; ?>#zoom=100&pagemode=thumbs" type="application/pdf" width="100%" height="100%">
                        alt : <a href="<?php echo $publico; ?>">Ver Manual de Usuario</a>
                    </object>
                <?php endif; ?>
                <div class="clearfix"></div>
            </div>
