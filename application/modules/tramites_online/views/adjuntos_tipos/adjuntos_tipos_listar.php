...
<script>
	...
	function complete_adjuntos_tipos_table() {
		agregar_filtros('adjuntos_tipos_table', adjuntos_tipos_table, 1);
	}
</script>
<?php if (!empty($error)) : ?>
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				...
				<?php echo anchor('tramites_online/adjuntos_tipos/agregar', 'Crear Tipo de Adjunto', 'class="btn btn-primary btn-sm"') ?>
