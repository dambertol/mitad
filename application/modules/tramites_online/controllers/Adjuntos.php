...
class Adjuntos extends MY_Upload
{
	...
	public function ver($entidad_nombre = NULL, $directorio_nombre = NULL, $sub_directorio_nombre = NULL, $archivo_id = NULL)
	{
		...
		else
		{
			...
			if (empty($persona_id))
			{
				show_error('No tiene permisos para la acción solicitada #1', 500, 'Acción no autorizada');
			}
			...
			{
				show_error('No tiene permisos para la acción solicitada #2', 500, 'Acción no autorizada');
			}
		}
		parent::ver();
	}
