...
<script>
	...
	function complete_documentos_table() {
		...
		$('#documentos_table tfoot th').eq(7).html('<button class="btn btn-xs btn-primary" onclick="limpiar_filtro(\'documentos_table\');"><i class="fa fa-eraser"></i></button>');
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				...
				<?php echo anchor('gobierno/documentos/agregar_decreto', 'Crear Decreto', 'class="btn btn-primary btn-sm"') ?>
