	...
	<div class="col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="row" id="row-escribano">
					<h2 class="text-center">Datos Escribano</h2>
				...
				<div class="text-center">
					...
					<a href="transferencias/escribanos/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
