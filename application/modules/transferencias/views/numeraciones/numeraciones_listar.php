...
<script>
	...
	function complete_numeraciones_table() {
		agregar_filtros('numeraciones_table', numeraciones_table, 2);
	}
</script>
<?php if (!empty($error)) : ?>
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				...
				<?php echo anchor('transferencias/numeraciones/agregar', 'Crear Numeración', 'class="btn btn-primary btn-sm"') ?>
