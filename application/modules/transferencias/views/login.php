...
<html lang="es">
	<head>
		...
		<title>Transferencias ON-LINE</title>
		<!-- Bootstrap Core CSS -->
		<link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
		<!-- iCheck -->
		<link href="vendor/icheck/skins/flat/yellow.css" rel="stylesheet">
		<!-- Custom styles -->
		<link href="css/transferencias/login.css" rel="stylesheet">
                <!-- jQuery -->
					...
					<div class="col-lg-3 col-lg-offset-8 col-md-4 col-md-offset-8 col-xs-12">
						<div class="login" id="card">
							<div class="front signin_form"> 
								...
								<br />
								<p style="text-align:center; font-size:18px;">TRANSFERENCIAS ON-LINE</p>
								...
								<p style="text-align:center;">
									<a href="img/transferencias/formularios/formulario_alta.pdf" target="_blank" class="btn btn-lg btn-success btn-block" style="font-size:20px;">
										Descargar Formulario <br> Alta de Usuario
									</a>
								</p>
							</div>
						</div>
