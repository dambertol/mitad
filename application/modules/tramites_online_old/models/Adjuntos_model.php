...
class Adjuntos_model extends MY_Model
{
    ...
    public function __construct()
    {
        ...
        $this->fields = array(
            ...
            'tramite' => array('label' => 'Consulta', 'input_type' => 'combo', 'type' => 'bselect'),
        ...
        $this->default_join = array(
            array('to_adjuntos_tipos', 'to_adjuntos_tipos.id = to_adjuntos.tipo_id', 'LEFT', array('to_adjuntos_tipos.nombre as tipo_adjunto')
        ));
    ...
    public function persona_adjunto($ruta, $nombre)
    {
        ...
        if (!empty($adjunto))
        {
            ...
            elseif (!empty($adjunto->pase_id))
            {
                ...
                $pase = $this->db->get('to_pases')->row(0);
        ...
        if (!empty($tramite_id))
        {
            ...
            $tramite = $this->db->get('to_tramites')->row(0);
            ;
            if (!empty($tramite))
            {
