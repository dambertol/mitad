...
class Adjuntos_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->table_name = 'vc_adjuntos';
		$this->full_log = TRUE;
		$this->msg_name = 'Adjunto';
		$this->id_name = 'id';
		$this->columnas = array('id', 'tipo_id', 'nombre', 'descripcion', 'ruta', 'tamanio', 'hash', 'fecha_subida', 'usuario_subida', 'vehiculo_id', 'audi_usuario', 'audi_fecha', 'audi_accion');
		$this->fields = array(
		...
		$this->default_join = array(
				array('vc_tipos_adjuntos', 'vc_tipos_adjuntos.id = vc_adjuntos.tipo_id', 'LEFT',
						array(
								'vc_tipos_adjuntos.nombre as tipo_adjunto'
						)
		));
	 ...
	 * @return bool
	 */
	public function delete_adjuntos($vehiculo_id)
	{
