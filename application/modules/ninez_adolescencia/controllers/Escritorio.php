...
class Escritorio extends MY_Controller
{
	...
	public function index()
	{
		...
		$data['title_view'] = 'Módulo Niñez y Adolescencia';
		$data['title'] = TITLE . ' - Escritorio';
		$data['accesos_esc'] = load_permisos_ninez_adolescencia_escritorio($this->grupos);
		$this->load_template('ninez_adolescencia/escritorio/content', $data);
	}
}