...
<div class="row">
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2><?php echo (!empty($title_view)) ? $title_view : 'Intervenciones'; ?></h2>
			...
			<div class="x_content">
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $intervencion->id) : ''; ?>
