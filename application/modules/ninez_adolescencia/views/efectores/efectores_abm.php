		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $efector->id) : ''; ?>
					<a href="ninez_adolescencia/efectores/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
