...
class Tipos_intervenciones_model extends MY_Model
{

	/**
	 * Modelo de Tipos de Intervención
	 * Autor: Leandro
	 * Creado: 09/09/2019
	...
	{
		parent::__construct();
		$this->table_name = 'na_tipos_intervenciones';
		$this->full_log = TRUE;
		$this->msg_name = 'Tipo de Intervención';
		$this->id_name = 'id';
	...
	{
		if ($this->db->where('tipo_intervencion_id', $delete_id)->count_all_results('na_intervenciones') > 0)
		{
