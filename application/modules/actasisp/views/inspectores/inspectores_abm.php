	...
	<div class="col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="row" id="row-inspector">
					<h2 class="text-center">Datos Inspector</h2>
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $inspector->id) : ''; ?>
					<a href="actasisp/inspectores/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
