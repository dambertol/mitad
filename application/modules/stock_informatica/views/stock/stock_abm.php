			...
			<div class="x_content">
				...
				<div class="row">
					<div class="row">
						...
						<?php endforeach; ?>
						<?php foreach ($fields_movimiento as $field): ?>
							<div class="form-group">
								<?php echo $field['label']; ?> 
								<?php echo $field['form']; ?>
							</div>
							...
							<div class="panel-body">
								<div class="row">
									<table class="table table-bordered table-condensed table-striped">
										...
										<tbody>
											<?php $cant_rows_nro = 0; ?>
											<?php foreach ($fields_detalle_movimiento_array as $Fields_detalle): ?>
												<?php $cant_rows_nro++; ?>
												<tr id="detalle_movimiento<?php echo $cant_rows_nro; ?>">
													<?php foreach ($Fields_detalle as $Field): ?>
														<?php if (isset($Field['type']) && $Field['type'] == 'hidden'): ?>
															<?php echo $Field['form']; ?>
														<?php else: ?>
