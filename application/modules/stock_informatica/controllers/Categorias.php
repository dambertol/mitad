...
class Categorias extends MY_Controller
{
	...
	public function listar()
	{
		...
		$tableData = array(
				...
				'source_url' => 'stock_informatica/categorias/listar_data',
				'reuse_var' => TRUE,
		...
		$this->load_template('stock_informatica/categorias/categorias_listar', $data);
	}
	...
	public function listar_data()
	{
		...
		$this->datatables
				...
				->from('si_categorias')
				->add_column('ver', '<a href="stock_informatica/categorias/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
				->add_column('editar', '<a href="stock_informatica/categorias/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
				->add_column('eliminar', '<a href="stock_informatica/categorias/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
	...
	public function agregar()
	{
		...
		if (in_groups($this->grupos_solo_consulta, $this->grupos))
		{
			...
			redirect('stock_informatica/categorias/listar', 'refresh');
		}
		...
		$this->load_template('stock_informatica/categorias/categorias_abm', $data);
	}
	...
	public function editar($id = NULL)
	{
		...
		{
			$this->session->set_flashdata('error', 'Usuario sin permisos de edición');
			redirect("stock_informatica/categorias/ver/$id", 'refresh');
		}
