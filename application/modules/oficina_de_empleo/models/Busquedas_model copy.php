...
class pedir_empleo_model extends MY_Model
{
	...
	public function __construct()
	{
		...
		$this->fields = array(    //estos campos son del formulario propio*******************************************
				...
				'idiomas' => array('label' => 'Idiomas', 'type' => 'text', 'style'=>"display:none" ,'maxlength' => '50'),							//idioma y nivel del 1-5
				'computacion' => array('label' => 'programa de Informatica', 'type' => 'text','style'=>"display:none" , 'maxlength' => '100'),				//programa y nivel del 1-5
				'cursos' => array('label' => 'Cursos', 'type' => 'text', 'rows' => 5, 'maxlength' => '100'),//otros cursos
				'oficios' => array('label' => 'oficios', 'type' => 'text', 'style'=>"display:none" ,'maxlength' => '100'),
				'experiencia' => array('label' => 'experiencia laboral', 'type' => 'text', 'maxlength' => '300'),				//rubro-puesto-duracion-personal a cargo s/n
				'exmuni' => array('label' => 'trabajo en la municipalidad','style'=>"display:none", 'type'=>'varchar','maxlength' => '1'),		//sn
				'famimuni' => array('label' => 'Familiares en la municipalidad','style'=>"display:none", 'type'=>'varchar','maxlength' => '1'),		//sn
