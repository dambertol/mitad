...
class Categorias extends MY_Controller
{
    ...
    public function listar()
    {
        ...
        $tableData = array(
            ...
            'source_url' => 'mas_beneficios/categorias/listar_data',
            'reuse_var' => TRUE,
        ...
        $this->load_template('mas_beneficios/categorias/categorias_listar', $data);
    }
    ...
    public function listar_data()
    {
        ...
        $this->datatables
                ...
                ->add_column('ver', '<a href="mas_beneficios/categorias/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
                ->add_column('editar', '<a href="mas_beneficios/categorias/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
                ->add_column('eliminar', '<a href="mas_beneficios/categorias/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
    ...
    public function agregar()
    {
        ...
        if (in_groups($this->grupos_solo_consulta, $this->grupos))
        {
            ...
            redirect('mas_beneficios/categorias/listar', 'refresh');
        }
        ...
        $this->load_template('mas_beneficios/categorias/categorias_abm', $data);
    }
    ...
    public function editar($id = NULL)
    {
        ...
        {
            $this->session->set_flashdata('error', '<br />Usuario sin permisos de edición');
            redirect("mas_beneficios/categorias/ver/$id", 'refresh');
        }

        $categoria = $this->Categorias_model->get(array('id' => $id));
        if (empty($categoria || $categoria->agrupamiento_id !== $this->agrupamiento_id_comercio))
        {
