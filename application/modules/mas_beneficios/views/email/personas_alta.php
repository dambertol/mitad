            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align:center; font-size:20px;">
                        <span style="line-height:100px;">Nuevo&nbsp;usuario&nbsp;para&nbsp;Más&nbsp;Beneficios</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <p style='text-align:justify;'>Le damos la bienvenida al programa Más Beneficios.</p>
                        <p style='text-align:justify;'>
                            Puede acceder al mismo a través de la siguiente URL: <a href="https://masbeneficios.lujandecuyo.gob.ar/auth/login" target="_blank">https://masbeneficios.lujandecuyo.gob.ar</a>
                        </p>
                        <p style='text-align:justify;'>
                        ...
                        <p style='text-align:justify;'>Una vez que ingrese al sistema podrá cambiar la contraseña por una de su preferencia.</p>
