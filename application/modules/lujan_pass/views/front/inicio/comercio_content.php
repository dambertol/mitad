    ...
    <section id="one">
        <div class="inner">
            <?php if (!empty($comercio)): ?>
                ...
                <div class="row gtr-uniform" style="margin-top:10px;">
                    <div class="col-2 off-1" style="text-align: center;">
                    ...
                    <div class="col-2" style="text-align: center;">
                        <?php if (!empty($comercio->latitud) && !empty($comercio->longitud)): ?>
                            <a href="https://www.google.com/maps/place/<?php echo "$comercio->latitud,$comercio->longitud"; ?>" target="_blank" title="Google Maps" class="icon alt fa fa-map-marker"></a>
                        <?php else: ?>
                            <div class="icon alt disabled fa fa-map-marker"></div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php else: ?>
