            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align:center; font-size:20px;">
                        <span style="line-height:100px;">Nuevo&nbsp;usuario&nbsp;para&nbsp;Luján&nbsp;Pass</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <p style='text-align:justify;'>Le damos la bienvenida al programa Luján Pass.</p>
                        <p style='text-align:justify;'>
                            Puede acceder al mismo a través de la siguiente URL: <a href="https://lujanpass.lujandecuyo.gob.ar/auth/login" target="_blank">https://lujanpass.lujandecuyo.gob.ar</a>
                        </p>
                        <p style='text-align:justify;'>
