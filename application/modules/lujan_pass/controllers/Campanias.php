...
class Campanias extends MY_Controller
{
    ...
    public function listar()
    {
        ...
        $tableData = array(
            ...
            'source_url' => 'lujan_pass/campanias/listar_data',
            'reuse_var' => TRUE,
        ...
        $this->load_template('lujan_pass/campanias/campanias_listar', $data);
    }
    ...
    public function listar_data()
    {
        ...
        $this->datatables
                ...
                ->add_column('ver', '<a href="lujan_pass/campanias/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
                ->add_column('editar', '<a href="lujan_pass/campanias/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
                ->add_column('eliminar', '<a href="lujan_pass/campanias/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
    ...
    public function agregar()
    {
        ...
        if (in_groups($this->grupos_solo_consulta, $this->grupos))
        {
            ...
            redirect('lujan_pass/campanias/listar', 'refresh');
        }
        ...
        $this->load_template('lujan_pass/campanias/campanias_abm', $data);
    }
    ...
    public function editar($id = NULL)
    {
        ...
        {
            $this->session->set_flashdata('error', 'Usuario sin permisos de edición');
            redirect("lujan_pass/campanias/ver/$id", 'refresh');
        }

        $campania = $this->Campanias_model->get(array('id' => $id));
        if (empty($campania) || $campania->agrupamiento_id !== $this->agrupamiento_id_turismo)
        {
