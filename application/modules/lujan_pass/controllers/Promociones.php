...
class Promociones extends MY_Controller
{
    ...
    public function listar()
    {
        ...
        $tableData = array(
            ...
            'source_url' => 'lujan_pass/promociones/listar_data',
            'reuse_var' => TRUE,
        ...
        $data['title_view'] = 'Listado de Descuentos';
        $data['title'] = TITLE . ' - Descuentos';
        $this->load_template('lujan_pass/promociones/promociones_listar', $data);
    }
    ...
    public function listar_data()
    {
        ...
        $dt->edit_column('estado', '$1', 'dt_column_promociones_estado(estado)', TRUE)
                ->add_column('ver', '<a href="lujan_pass/promociones/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
                ->add_column('editar', '<a href="lujan_pass/promociones/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
                ->add_column('anular', '<a href="lujan_pass/promociones/anular/$1" title="Anular" class="btn btn-primary btn-xs"><i class="fa fa-ban"></i></a>', 'id')
                ->add_column('eliminar', '<a href="lujan_pass/promociones/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
    ...
    public function agregar()
    {
        ...
        if (in_groups($this->grupos_solo_consulta, $this->grupos))
        {
            ...
            redirect('lujan_pass/promociones/listar', 'refresh');
        }

        if (in_groups($this->grupos_admin, $this->grupos))
        {
            redirect('lujan_pass/promociones/agregar_admin', 'refresh');
        }
        ...
        $this->array_campania_control = $array_campania = $this->get_array('Campanias', 'nombre', 'id', array(
            ...
            'where' => array(
                ...
                array('column' => 'ta_campanias.agrupamiento_id', 'value' => $this->agrupamiento_id_turismo),
            ),
        ...
        if ($this->form_validation->run() === TRUE)
        {
            ...
            if (!empty($_FILES['imagen_url']['name']))
            {
                ...
                $config['upload_path'] = "uploads/lujan_pass/promociones/";
        ...
        $data['title_view'] = 'Agregar Descuento';
        $data['title'] = TITLE . ' - Agregar Descuento';
        ...
        $this->load_template('lujan_pass/promociones/promociones_abm', $data);
    }
    ...
    public function editar($id = NULL)
    {
        ...
        {
            $this->session->set_flashdata('error', 'Usuario sin permisos de edición');
            redirect("lujan_pass/promociones/ver/$id", 'refresh');
        }
        ...
        if (empty($promocion) || $promocion->agrupamiento_id !== $this->agrupamiento_id_turismo)
        {
            show_error('No se encontró el Descuento', 500, 'Registro no encontrado');
        }
        ...
        $data['txt_btn'] = 'Editar';
        $data['title_view'] = 'Editar Descuento';
        $data['title'] = TITLE . ' - Editar Descuento';
        $data['css'][] = 'vendor/bootstrap-fileinput/css/fileinput.min.css';
        $data['js'][] = 'vendor/bootstrap-fileinput/js/fileinput.min.js';
        $data['js'][] = 'vendor/bootstrap-fileinput/js/locales/es.js';
        $data['js'][] = 'vendor/bootstrap-fileinput/themes/fa/theme.min.js';
    ...
    public function eliminar($id = NULL)
    {
        ...
        $data['title_view'] = 'Eliminar Descuento';
        $data['title'] = TITLE . ' - Eliminar Descuento';
        $this->load_template('lujan_pass/promociones/promociones_abm', $data);
    }
    ...
    public function anular($id = NULL)
    {
        ...
        $data['promocion'] = $promocion;
        $data['txt_btn'] = 'Anular';
        $data['title_view'] = 'Anular Descuento';
        $data['title'] = TITLE . ' - Anular Descuento';
        $this->load_template('lujan_pass/promociones/promociones_abm', $data);
    }
    ...
    public function aprobar($id = NULL)
    {
        ...
        $data['title_view'] = 'Aprobar Descuento';
        $data['title'] = TITLE . ' - Aprobar Descuento';
        $this->load_template('lujan_pass/promociones/promociones_abm', $data);
    }
    ...
    public function ver($id = NULL)
    {
        ...
        $data['promocion'] = $promocion;
        $data['txt_btn'] = NULL;
        $data['title_view'] = 'Ver Descuento';
        $data['title'] = TITLE . ' - Ver Descuento';
        $this->load_template('lujan_pass/promociones/promociones_abm', $data);
    }
}
