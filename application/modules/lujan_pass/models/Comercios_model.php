...
class Comercios_model extends MY_Model
{
    ...
    public function __construct()
    {
        ...
        $this->id_name = 'id';
        $this->columnas = array('id', 'nombre', 'razon_social', 'padron', 'padron_c', 'cuit', 'calle', 'altura', 'localidad_id', 'latitud', 'longitud', 'telefono', 'email', 'web', 'facebook', 'instagram', 'twitter', 'envio_domicilio', 'encargado_id', 'imagen_url', 'latitud', 'longitud', 'comentarios', 'estado', 'audi_usuario', 'audi_fecha', 'audi_accion');
        $this->fields = array(
    ...
    protected function _can_delete($delete_id)
    {
        ...
        {
            $this->_set_error('No se ha podido eliminar el registro de ' . $this->msg_name . '. Verifique que no esté asociado a un Descuento.');
            return FALSE;
        }
        return TRUE;
    }
