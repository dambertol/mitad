<!--
	/*
	 * Vista ABM de Tipo de Movimiento.
	 * Autor: GENERATOR_MLC
	 * Creado: 02/07/2019
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $cedulas_movimientos_tipo->id) : ''; ?>
					<a href="notificaciones/cedulas_movimientos_tipos/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
