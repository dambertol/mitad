...
<script>
	...
	function complete_compras_table() {
		...
		$('#compras_table tfoot th').eq(9).html('<button class="btn btn-xs btn-primary" onclick="limpiar_filtro(\'compras_table\');"><i class="fa fa-eraser"></i></button>');
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				...
				<?php echo anchor('obrador/compras/agregar', 'Crear Compra', 'class="btn btn-primary btn-sm"') ?>
