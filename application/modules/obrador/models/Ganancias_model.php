...
class Ganancias_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->table_name = 'ob_ganancias';
		$this->full_log = TRUE;
		$this->msg_name = 'Ganancia';
		$this->id_name = 'id';
	...
	{
		if ($this->db->where('ganancia_id', $delete_id)->count_all_results('ob_proveedores') > 0)
		{
