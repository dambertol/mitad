...
class Tipos_proveedores_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->table_name = 'ob_tipos_proveedores';
		$this->full_log = TRUE;
		$this->msg_name = 'Tipo de Proveedor';
		$this->id_name = 'id';
	...
	{
		if ($this->db->where('tipo_proveedor_id', $delete_id)->count_all_results('ob_proveedores') > 0)
		{
