...
<?php if ($txt_btn === 'Agregar'): ?>
			var inicial = $('#ubicacion').selectpicker('val');
			...
			$('#ubicacion').on('changed.bs.select', function(e) {
...
<?php endif; ?>
		cambiarTipoConcesion();
		$('#tipo_concesion').change(function() {
			cambiarTipoConcesion();
		});
	});
</script>
	...
	<div class="col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<?php endif; ?>
				<div class="row">
					<h2 class="text-center">Datos Concesión</h2>
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $concesion->id) : ''; ?>
					<a href="defunciones/concesiones/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
