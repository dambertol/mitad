	...
	<div class="col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<?php endif; ?>
				<div class="row">
					<h2 class="text-center">Datos Ornato</h2>
				...
				<div class="text-center">
					...
					<?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar') ? form_hidden('id', $ornato->id) : ''; ?>
					<a href="defunciones/ornatos/listar" class="btn btn-default btn-sm">Cancelar</a>
				</div>
				<?php echo form_close(); ?>
			</div>
		</div>
