...
class Ornatos_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->table_name = 'df_ornatos';
		$this->full_log = TRUE;
		$this->msg_name = 'Ornato';
		$this->id_name = 'id';
		$this->columnas = array('id', 'operacion_id', 'tipo_ornato', 'constructor_id', 'ubicacion_id', 'audi_usuario', 'audi_fecha', 'audi_accion');
		$this->fields = array(
				'tipo_ornato' => array('label' => 'Tipo de Ornato', 'maxlength' => '50', 'required' => TRUE),
				'fecha_tramite' => array('label' => 'Fecha Trámite', 'type' => 'date', 'required' => TRUE),
				'constructor' => array('label' => 'Constructor', 'input_type' => 'combo', 'type' => 'bselect', 'required' => TRUE),
		...
		$this->default_join = array(
				...
				array('df_constructores', 'df_constructores.id = df_ornatos.constructor_id', 'LEFT', array("df_constructores.nombre as constructor")),
				array('df_ubicaciones', 'df_ubicaciones.id = df_ornatos.ubicacion_id', 'LEFT'),
