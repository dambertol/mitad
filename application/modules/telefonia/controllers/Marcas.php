...
class Marcas extends MY_Controller
{
	...
	public function listar()
	{
		...
		$tableData = array(
			...
			'source_url' => 'telefonia/marcas/listar_data',
			'reuse_var' => TRUE,
		...
		$this->load_template('telefonia/marcas/marcas_listar', $data);
	}
	...
	public function listar_data()
	{
		...
		$this->datatables
			->select('id, nombre')
			->from('tm_marcas')
			->add_column('ver', '<a href="telefonia/marcas/ver/$1" title="Ver" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>', 'id')
			->add_column('editar', '<a href="telefonia/marcas/editar/$1" title="Editar" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>', 'id')
			->add_column('eliminar', '<a href="telefonia/marcas/eliminar/$1" title="Eliminar" class="btn btn-primary btn-xs"><i class="fa fa-times"></i></a>', 'id');
	...
	public function agregar()
	{
		...
		if (in_groups($this->grupos_solo_consulta, $this->grupos))
		{
			...
			redirect('telefonia/marcas/listar', 'refresh');
		}
		...
		$this->load_template('telefonia/marcas/marcas_abm', $data);
	}
	...
	public function editar($id = NULL)
	{
		...
		{
			$this->session->set_flashdata('error', 'Usuario sin permisos de edición');
			redirect("telefonia/marcas/ver/$id", 'refresh');
		}
