...
<script>
	...
	function complete_movimientos_table() {
		...
		$('#movimientos_table tfoot th').eq(10).html('<button class="btn btn-xs btn-primary" onclick="limpiar_filtro(\'movimientos_table\');" title="Limpiar filtros"><i class="fa fa-eraser"></i></button>');
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				...
				<?php echo anchor('telefonia/movimientos/agregar/1', 'Entrega', 'class="btn btn-primary btn-sm"') ?>
				<?php echo anchor('telefonia/movimientos/agregar/2', 'Recepción', 'class="btn btn-primary btn-sm"') ?>
				<?php echo anchor('telefonia/movimientos/agregar/3', 'Cambio de Plan', 'class="btn btn-primary btn-sm"') ?>
				<?php echo anchor('telefonia/movimientos/agregar/4', 'Cambio de Equipo', 'class="btn btn-primary btn-sm"') ?>
