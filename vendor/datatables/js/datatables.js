 ...
 *   https://datatables.net/download/#bs/dt-1.10.21/b-1.6.2/b-print-1.6.2/cr-1.5.2/r-2.2.5
 *
 * Included libraries:
 *   DataTables 1.10.21, Buttons 1.6.2, Print view 1.6.2, ColReorder 1.5.2, Responsive 2.2.5
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.21/b-1.6.2/b-print-1.6.2/cr-1.5.2/r-2.2.5",
